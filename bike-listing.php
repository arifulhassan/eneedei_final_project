...
<title>Emergency Courier Service Portal | Emergency Courier Service Listing</title>
<!--Bootstrap -->
...
{  ?>
        <div class="product-listing-m gray-bg">
          ...
          <div class="product-listing-content">
            ...
            <p class="list-price">TK <?php echo htmlentities($result->PricePerDay);?> Service Charge</p>
            <ul>
              <!-- <li><i class="fa fa-user" aria-hidden="true"></i><?php echo htmlentities($result->SeatingCapacity);?> Total seats</li>
              <li><i class="fa fa-calendar" aria-hidden="true"></i><?php echo htmlentities($result->ModelYear);?> Time</li> -->
