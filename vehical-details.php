...
$status=0;
$vhid=$_GET['vhid'];
$sql="INSERT INTO  tblbooking(userEmail,VehicleId,From_Name,To_Name,From_Address,FromDate,From_Contact_No,To_Contact_No,payment_Type,Payment_Category,Payment_ID,message,Status) VALUES(:useremail,:vhid,:fromname,:toname,:fromaddress,:fromdate,:fromcontactno,:tocontactno,:delivaryprocess,:delivarysystem,:paymentid,:message,:status)";
    ...
    <div class="listing_detail_head row">
      ...
      <div class="col-md-3">
        <div class="price_info">
          <p>TK <?php echo htmlentities($result->PricePerDay);?> </p> Delivary Charge Per Kg.
...
<tr>
<td>Dutch Bangla Bank : 122145754321</td>
          ...
          <div class="product-listing-m gray-bg">
            ...
            <div class="product-listing-content">
             ...
             <!-- <li><i class="fa fa-user" aria-hidden="true"></i><?php echo htmlentities($result->SeatingCapacity);?> Seat</li>
                <li><i class="fa fa-calendar" aria-hidden="true"></i><?php echo htmlentities($result->ModelYear);?> Time Sheduling</li> -->
