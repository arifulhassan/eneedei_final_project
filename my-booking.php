    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-8">
        <div class="profile_wrap">
          <h5 class="underline">My Package Parcel Delivery Details </h5>
...
<li>
                ...
                <div class="vehicle_title">
                  ...
                  <p><b>To Address:</b> <?php echo htmlentities($result->FromDate);?><br /> <b>To Contact:</b> <?php echo htmlentities($result->ToDate);?></p>
                </div>
