...
<title>Emergency Courier Service | Delivery Listing</title>
<!--Bootstrap -->
...
{  ?>
        <div class="product-listing-m gray-bg">
          ...
          <div class="product-listing-content">
            ...
            <p class="list-price">TK <?php echo htmlentities($result->PricePerDay);?> Delivery Charge Per Kg</p>
            <ul>
              <li><i class="fa fa-user" aria-hidden="true"></i><?php echo htmlentities($result->SeatingCapacity);?> Package</li>
              <li><i class="fa fa-calendar" aria-hidden="true"></i><?php echo htmlentities($result->ModelYear);?> Branch</li>
      ...
      <aside class="col-md-3 col-md-pull-9">
		...
		<option value="Others Delivary">Others Delivery</option>
								</select>
							</div>
        ...
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-car" aria-hidden="true"></i> Recently Listed Package</h5>
          </div>
...
{  ?>
              ...
              <li class="gray-bg">
                ...
                <div class="recent_post_title"> <a href="vehical-details.php?vhid=<?php echo htmlentities($result->id);?>"><?php echo htmlentities($result->BrandName);?> , <?php echo htmlentities($result->VehiclesTitle);?></a>
                  <p class="widget_price">TK <?php echo htmlentities($result->PricePerDay);?> Delivery Charge Per Kg</p>
                </div>
              </li>
              <?php }} ?>
