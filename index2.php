...
<html lang="en">
	...
	<body class="landing">
		...
		<!-- Header -->
			<header id="header">
				<h1><a href="index.php">Book My Delivary promoCode</a></h1>
				<nav id="nav">
					<ul>
		...
		<!-- Banner -->
			<section id="banner">
				<h2>Emergency Courier Service</h2>
				<p>Quick Search <br> Online Bookings <br> Pay Online <br> Hassle Free Delivary Booking<br>Brought To You By Emergency Courier Service</p>
				<ul class="actions">
					<li>
		...
		<a name="about"></a>
			<section id="one" class="wrapper style1 align-center">
				<div class="container">
					<header>
						<h2>Hassle Free Delivary Booking</h2>
						<p> <b>Hassle Free Delivary Booking is a online bus reservation system. <br>You can now choose your bus and your seat easily, have the tickets delivered to your mail and online payments. <br>Try Hassle Free Delivary Booking experience today.</b></p>

					</header>
					<div class="row 200%">
						<section class="4u 12u$(small)">
							<i class="icon big rounded fa-clock-o"></i>
							<p>You can book the delivary before one month<br> You can cancel the delivary one day before the journey with 100% refund</p>
						</section>
						<section class="4u 12u$(small)">
		...
		<!-- Two -->
			<section id="two" class="wrapper style2 align-center">
				<div class="container">
					...
					-->	</section>
						<p><b> Why Hassle Free Delivary Booking for Bus Booking? </b>
...
<p><b>Booking Bus Ticket with BookMyBusTicket</b> <br>
	With more than 68 bus routes spread across the District and integration with over 1300 bus operators, MakeMyTrip's online bus reservation system is simpler and smarter. It provides you a wide range of facilities, right from choosing your pickup point to your preferred choice of seat (for instance, luxury buses with sleeper berths). You can also choose from the widest range of available buses like Mercedes, Volvo, Volvo AC, AC luxury, Deluxe, Sleeper, Express and other private buses. The payment options are easier too- you can use either debit/credit card facility or net-banking. Not just that, in case of any change in your travel plan, bus tickets can be cancelled online. So, next time you need not stand in long queues or search at different bus ticket counters. You can directly book bus tickets online with Hassle Free Delivary Booking.com and stay assured.</p>
					...
					<footer>
						...
						<p> <b> SAVE BIG ONE BUS TICKETS!! GET UPTO TK.300 INSTANT DISCOUNT. <BR> COUPON CODE : DISBOOKBUS </b></p>
					</footer>
				</div>
			</section>
			...
			<!--				<ul class="icons">
					...
					-->		<ul class="tabular">
								<li>
									<h3>Address</h3>
									Sherpur Road<br>
									<a href="ebariobari@gmail.com">AFT-Projects</a> 01745-367286
								</li>
								<li>
									<h3>Mail</h3>
									<a href="#">ecs@gmail.com</a>
								</li>
								<li>
									<h3>Phone</h3>
									01745-367286
					...
					<ul class="copyright">
						<li>&copy; 2017 BookMyBusTicket. All rights reserved. Brought To You By <a href="#">Ariful Hassan</a></li>
