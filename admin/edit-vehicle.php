...
<head>
	...
	<title>Emergency Courier Service | Admin Edit Package Info</title>
...
<label class="col-sm-2 control-label">Select Branch<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-2 control-label">Service Charge Per Kg(in Tk)<span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="priceperday" class="form-control" value="<?php echo htmlentities($result->priceperday);?>" required>
</div>
<label class="col-sm-2 control-label">Select Package Type<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-2 control-label">Time Schedule<span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="modelyear" class="form-control" value="<?php echo htmlentities($result->ModelYear);?>" required>
</div>
<label class="col-sm-2 control-label">Delivery Seating Capacity<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<label for="inlineCheckbox1"> Cash On Delivery </label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
<input type="checkbox" id="inlineCheckbox1" name="airconditioner" value="1">
<label for="inlineCheckbox1"> Life Time Free Service </label>
</div>
<?php } ?>
</div>
<div class="col-sm-3">
...
<label for="inlineCheckbox2"> Offer Package </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-success checkbox-inline">
<input type="checkbox" id="inlineCheckbox1" name="powerdoorlocks" value="1">
<label for="inlineCheckbox2"> Promo Code:  453621 </label>
</div>
<?php }?>
</div>
<div class="col-sm-3">
...
<label for="inlineCheckbox3"> Special Offer </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
<input type="checkbox" id="inlineCheckbox1" name="antilockbrakingsys" value="1">
<label for="inlineCheckbox3"> Delivery Charge Free </label>
</div>
<?php } ?>
</div>
<div class="col-sm-3">
...
<label for="inlineCheckbox3"> Baksh : 01745-367286 </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
<input type="checkbox" id="inlineCheckbox1" name="brakeassist" value="1">
<label  for="inlineCheckbox3"> Rocket : 01305-883338 </label>
</div>
<?php } ?>
</div>
...
<label for="inlineCheckbox1"> Dutch Bangla Bank : 122145754321 </label>
</div>
<?php } else {?>
<div class="col-sm-3">
<div class="checkbox checkbox-inline">
<input type="checkbox" id="inlineCheckbox1" name="powersteering" value="1">
<label for="inlineCheckbox1"> Quickly Delivary </label>
</div>
<?php } ?>
</div>
<div class="col-sm-3">
...
<label for="inlineCheckbox2">aaaaaaaa</label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
<input type="checkbox" id="inlineCheckbox1" name="driverairbag" value="1">
<label for="inlineCheckbox2">bbbbbbb</label>
<?php } ?>
</div>
<div class="col-sm-3">
<?php if($result->DriverAirbag==1)
...
<label for="inlineCheckbox3"> cccccccc </label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
<input type="checkbox" id="inlineCheckbox1" name="passengerairbag" value="1">
<label for="inlineCheckbox3"> Normal Delivery </label>
</div>
<?php } ?>
</div>
<div class="col-sm-3">
...
<label for="inlineCheckbox3"> Emergency Delivery</label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
<input type="checkbox" id="inlineCheckbox1" name="powerwindow" value="1">
<label for="inlineCheckbox3"> Others Delivery </label>
</div>
<?php } ?>
</div>
...
<label for="inlineCheckbox1"> eeeeeeee </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
<input type="checkbox" id="inlineCheckbox1" name="cdplayer" value="1">
<label for="inlineCheckbox1"> fffffffff </label>
</div>
<?php } ?>
</div>
<div class="col-sm-3">
...
<label for="inlineCheckbox2">ggggggggggg</label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-success checkbox-inline">
<input type="checkbox" id="inlineCheckbox1" name="centrallocking" value="1">
<label for="inlineCheckbox2">hhhhhhhhhh</label>
</div>
<?php } ?>
</div>
<div class="col-sm-3">
...
<label for="inlineCheckbox3"> iiiiiiiiiii </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
<input type="checkbox" id="inlineCheckbox1" name="crashcensor" value="1">
<label for="inlineCheckbox3"> jjjjjjjjjjj </label>
</div>
<?php } ?>
</div>
<div class="col-sm-3">
...
<label for="inlineCheckbox3"> kkkkkkkkkkkk </label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
<input type="checkbox" id="inlineCheckbox1" name="leatherseats" value="1">
<label for="inlineCheckbox3"> llllllllllllll </label>
</div>
<?php } ?>
</div>
</div>
