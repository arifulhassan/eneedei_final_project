...
<head>
	...
	<title>Emergency Courier Service | Admin Create Branch</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Change Dynamicly</h2>
                  ...
                  <option value="manage-pages.php?type=servicearea">Service Area</option>
                </select>
												</div>
											</div>
