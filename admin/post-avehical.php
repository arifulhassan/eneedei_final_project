...
if($lastInsertId)
{
$msg="Delivary posted successfully";
}
else
{
...
<head>
	...
	<title>Package | Admin Post Package</title>
...
<label class="col-sm-2 control-label">Delivary Seating Capacity<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<label for="antilockbrakingsys"> Cash On Delivery </label>
</div></div>
<div class="checkbox checkbox-inline">
<input type="checkbox" id="brakeassist" name="brakeassist" value="1">
<label for="brakeassist"> Life Time Free Service </label>
</div>
</div>
...
<input type="checkbox" id="powersteering" name="powersteering" value="1">
<label for="inlineCheckbox5"> Offer Package </label>
</div>
</div>
...
<label for="centrallocking">Promo Code:  453621</label>
</div></div>
<div class="col-sm-3">
<div class="checkbox checkbox-inline">
<input type="checkbox" id="crashcensor" name="crashcensor" value="1">
<label for="crashcensor"> Special Offer </label>
</div></div>
<div class="col-sm-3">
<div class="checkbox checkbox-inline">
<input type="checkbox" id="leatherseats" name="leatherseats" value="1">
<label for="leatherseats"> Delivery Charge Free </label>
</div>
</div>
</div>
